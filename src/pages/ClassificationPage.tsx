    ...
    <div className="p-6 flex flex-col justify-center items-center">
      ...
      <div className="w-[90%]">
        ...
        <div className="bg-white h-[20rem] w-[100%] flex justify-center items-center flex-col gap-6 border-2 border-dashed border-[#082640] rounded-xl mb-16">
          ...
          <div>
            <h3 className="text-[#010A26] font-medium text-lg">Arraste o PDF aqui</h3>
            <p className="text-[#9799A6]">Ou clique para selecionar arquivo</p>
          </div>
          <button className="font-bold text-base bg-[#0F3B57] py-2 px-4 text-white rounded-lg">Selecionar PDF</button>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="text-left space-y-4 mb-14">
            ...
            <textarea className="border p-2 w-full bg-white border-[#082640] rounded-md mt-[0.6rem] h-30 resize-none" name="description" placeholder="Descrição adicional do componente" value={form.description} onChange={handleChange} />
