  ...
  return (
    <div className="p-6">
      <div className="mb-24">
        ...
        <h2 className="font-semibold text-[#010A26] text-2xl mb-3 text-left">Upload de Documento</h2>
        <div className="bg-white h-[20rem] w-[100%] flex justify-center items-center flex-col">
          <FontAwesomeIcon icon={faArrowUpFromBracket} className="text-[#9799A6] text-4xl"/>
        ...
        <h2 className="font-semibold text-[#010A26] text-2xl text-left">Entrada Manual</h2>
