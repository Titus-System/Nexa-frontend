        ...
        <div className={`relative w-full mb-28 ${darkMode ? "bg-[#010A26]" : ""}`}>
            <div className="mt-[3.5rem]">
                ...
                <div className="flex flex-col mb-6">
                    <div className="absolute top-[26%] left-[5%] w-40 h-40 p-7 rounded-full bg-white shadow-lg flex items-center justify-center text-7xl font-bold text-[#082640] border-4 border-white">
                        {initials}
                    </div>
